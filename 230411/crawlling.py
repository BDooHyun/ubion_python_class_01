...
path = "C:\\Users\\duja1\\OneDrive\\문서\\GitHub\\ubion_python_class_01\\chromedriver.exe"
...
df.to_csv(f"C:/Users/duja1/OneDrive/문서/GitHub/ubion_python_class_01/230411/test({now}).csv", index = False)
pd.read_csv(f"test({now}).csv")